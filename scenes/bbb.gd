...
@export var messages: Array[String] = ["This is Nip and his place.","Nip is an architect/engineer who was kicked off the island and feels useless because he hasn't done anything."]
