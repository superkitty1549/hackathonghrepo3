...
@export var messages: Array[String] = ["This is Scout F and his place.","Scout F is a part of a cub scout troop that was supposed to be on the island for two weeks.","He's not very good at survival and now lives there."]
