...
@export var messages: Array[String] = ["This is Biscuits and his place.","Biscuits used to live underwater but washed up onto the shore, where the tide sometimes pushes him back into the water.","Biscuits lives in the lighthouse and has an unusual diet."]
