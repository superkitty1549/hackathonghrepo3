...
@export var messages: Array[String] = ["It's honestly kind of creepy how the houses are all such weirdly coloured...","The villagers and the houses are nothing like what they taught us in school..."]
