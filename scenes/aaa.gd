...
@export var messages: Array[String] = ["This is Kami and her place.", "Kami is a local who's always trying to happy, partially because she feels like she's being watched."]
