...
@export var messages: Array[String] = ["This is Lamber and his place.","Lamber is a hippie who sees the wrong on the island and refuses to do anything because like... it's just nature, man..."]
