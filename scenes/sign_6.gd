...
@export var messages: Array[String] = ["Oh, and this is Biscuit's house!","I remember in the stories, Biscuit was always my favourite character!","Hm...","But, where is Biscuit?"]
